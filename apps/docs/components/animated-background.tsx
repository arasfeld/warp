    ...
    <>
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-15 dark:opacity-40">
          <div
            className="absolute rounded-full border-[3px] border-purple-500/40 dark:border-purple-500/30 w-[800px] h-[800px] animate-vortex-rotate"
            style={{ animationDuration: '15s' }}
          />
          <div
            className="absolute rounded-full border-[3px] border-blue-500/40 dark:border-blue-500/30 w-[650px] h-[650px] animate-vortex-rotate"
            style={{ animationDuration: '12s' }}
          />
          <div
            className="absolute rounded-full border-[3px] border-cyan-400/40 dark:border-cyan-400/30 w-[500px] h-[500px] animate-vortex-rotate"
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(circle, rgb(168, 85, 247), transparent)',
          }}
        />
        <div
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(circle, rgb(102, 126, 234), transparent)',
            animationDelay: '16s',
          }}
        />
      </div>
