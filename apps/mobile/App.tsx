    ...
    <ThemeProvider>
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.buttonGroup}>
          ...
          <Button variant="secondary" size="md" onPress={() => console.log('secondary pressed')}>
            Secondary Button
          </Button>
          
          <Button variant="outline" size="md" onPress={() => console.log('outline pressed')}>
            Outline Button
          </Button>
        </View>
        ...
        <View style={styles.buttonGroup}>
          <Button variant="primary" size="md" disabled onPress={() => console.log('disabled pressed')}>
            Disabled Button
          </Button>
        </View>
      </ScrollView>
