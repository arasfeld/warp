 ...
 */
export function createThemeVars(palette: Palette): ReturnType<typeof vars> {
  ...
  return vars({
    ...
    '--secondary-foreground': extractHslValues(
      palette.secondary.contrastText || palette.text.primary,
    ),
