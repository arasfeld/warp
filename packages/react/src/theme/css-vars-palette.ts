...
export function updatePaletteCSSVariables(palette: Palette): void {
  ...
  root.style.setProperty(
    ...
    extractHslValues(palette.primary.main)
  );
  if (palette.primary.light) {
    root.style.setProperty(
      "--palette-primary-light",
      extractHslValues(palette.primary.light)
    );
  }
  if (palette.primary.dark) {
    root.style.setProperty(
      "--palette-primary-dark",
      extractHslValues(palette.primary.dark)
    );
  }
  ...
  root.style.setProperty(
    ...
    extractHslValues(palette.secondary.main)
  );
  if (palette.secondary.light) {
    root.style.setProperty(
      "--palette-secondary-light",
      extractHslValues(palette.secondary.light)
    );
  }
  if (palette.secondary.dark) {
    root.style.setProperty(
      "--palette-secondary-dark",
      extractHslValues(palette.secondary.dark)
    );
  }
  ...
  root.style.setProperty(
    "--palette-error-main",
    extractHslValues(palette.error.main)
  );
  root.style.setProperty(
    "--palette-warning-main",
    extractHslValues(palette.warning.main)
  );
  root.style.setProperty(
    "--palette-info-main",
    extractHslValues(palette.info.main)
  );
  root.style.setProperty(
    "--palette-success-main",
    extractHslValues(palette.success.main)
  );
  ...
  root.style.setProperty(
    "--palette-action-hover-opacity",
    palette.action.hoverOpacity.toString()
  );
  root.style.setProperty("--palette-action-selected", palette.action.selected);
  root.style.setProperty(
    "--palette-action-selected-opacity",
    palette.action.selectedOpacity.toString()
  );
  root.style.setProperty("--palette-action-disabled", palette.action.disabled);
  root.style.setProperty(
    "--palette-action-disabled-background",
    palette.action.disabledBackground
  );
  root.style.setProperty(
    "--palette-action-disabled-opacity",
    palette.action.disabledOpacity.toString()
  );
  root.style.setProperty("--palette-action-focus", palette.action.focus);
  root.style.setProperty(
    "--palette-action-focus-opacity",
    palette.action.focusOpacity.toString()
  );
  root.style.setProperty(
    "--palette-action-activated-opacity",
    palette.action.activatedOpacity.toString()
  );
  ...
  root.style.setProperty(
    "--action-active",
    extractActionColor(palette.action.active)
  );
  root.style.setProperty(
    "--action-hover",
    extractActionColor(palette.action.hover)
  );
  root.style.setProperty(
    "--action-selected",
    extractActionColor(palette.action.selected)
  );
  root.style.setProperty(
    "--action-disabled",
    extractActionColor(palette.action.disabled)
  );
  root.style.setProperty(
    "--action-focus",
    extractActionColor(palette.action.focus)
  );
  ...
  root.style.setProperty(
    "--background",
    getColorForCSSVar(palette.background.default)
  );
  ...
  if (palette.text.primary.startsWith("hsl(")) {
    ...
    if (hslMatch?.[1]) {
      ...
      if (valuesMatch?.[1] && valuesMatch[2] && valuesMatch[3]) {
      ...
      root.style.setProperty(
        "--foreground",
        extractHslValues(palette.text.primary)
      );
    }
  } else {
  ...
  root.style.setProperty(
    "--primary-foreground",
    palette.primary.contrastText || (isDark ? "#000000" : "#ffffff")
  );
  ...
  const secondaryForeground =
    palette.secondary.contrastText ||
    (isDark ? "#ffffff" : extractHslValues(palette.text.primary));
  if (secondaryForeground.startsWith("hsl(")) {
    root.style.setProperty(
      "--secondary-foreground",
      extractHslValues(secondaryForeground)
    );
  } else {
  ...
  root.style.setProperty(
    "--muted",
    getColorForCSSVar(palette.background.paper)
  );
  root.style.setProperty(
    "--card-background",
    getColorForCSSVar(palette.background.paper)
  ...
  if (palette.text.secondary.startsWith("hsl(")) {
    ...
    if (hslMatch?.[1]) {
      ...
      root.style.setProperty(
        "--muted-foreground",
        extractHslValues(palette.text.secondary)
      );
    }
  } else {
  ...
  root.style.setProperty(
    "--button-disabled-bg",
    extractActionColor(palette.action.disabledBackground)
  );
  root.style.setProperty(
  ...
  if (isDark) {
    ...
    root.style.setProperty(
      "--button-active-bg-dark",
      extractActionColor(palette.action.active)
    );
    root.style.setProperty(
      "--button-disabled-bg-dark",
      extractActionColor(palette.action.disabledBackground)
    );
    root.style.setProperty(
      "--button-disabled-text-dark",
      extractActionColor(palette.action.disabled)
    );
  }
}
...
export function updateThemeCSSVariables(theme: Theme): void {
  ...
  variants.forEach((variant) => {
    ...
    if (variantConfig.letterSpacing) {
      root.style.setProperty(
        ...
        String(variantConfig.letterSpacing)
      );
    }
  });
  ...
  root.style.setProperty(
    ...
    `${theme.typography.htmlFontSize}px`
  );
  root.style.setProperty(
  ...
  root.style.setProperty(
    "--shape-border-radius-sm",
    `${Math.max(0, baseRadius - 2)}px`
  );
  root.style.setProperty(
    "--shape-border-radius-md",
    `${Math.max(0, baseRadius - 1)}px`
  );
